...
export function ContactoPage() {
  ...
  return (
    <>
      <PageHero image={images.panoramica} alt="Contacto" content={contactoHero} />

      <AnimatedSection className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <FadeIn className="max-w-lg mx-auto">
            <form onSubmit={handleSubmit} className="bg-white rounded-xl p-5 sm:p-8 shadow-xl border border-gray-100">
